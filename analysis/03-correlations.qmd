---
title: "Correlation analysis of Mediobasal Hypothalamus astrocytes dataset from Rupp AC et al 2021"
...
DOCNAME <- "correlations-within-astrocytes-dataset-from-rupp2021"
NOW <- Sys.time()
...
```{r params}
bioproject <- "PRJNA723345"
project <- "rupp2021_MBH"
cb_fpr <- 0.001
low_cutoff_gene <- 500
...
## Load selected astrocytes data from Rupp AC et al 2021
...
plt_grp_ggcorrmat <- grouped_ggcorrmat(
  ...
  annotation.args = list(
    ...
    caption = "Dataset: subset of astrocytes from the Mediobasal Hypothalamus of the mouse hypothalamus (Rupp AC et al 2021)"
  )
)
